...
public class Main2Activity extends AppCompatActivity implements View.OnClickListener {
    ...
    void salvaDados(){
        ...
        if(rb_q1_b.isChecked()){
            q1 = "b";

        }else
        if(rb_q1_c.isChecked()){
            q1 = "c";

        }else
        if(rb_q1_d.isChecked()){
            q1 = "d";

        }else
        if(rb_q1_e.isChecked()){
            q1 = "e";
        }
        ...
        if(rb_q4_b.isChecked()){
            q4 = "b";
        }else
        if(rb_q4_c.isChecked()){
            q4 = "c";
        }else
        if(rb_q4_d.isChecked()){
            q4 = "d";
        }
        ...
        if(rb_q5_b.isChecked()){
            q5 = "b";

        }else
        if(rb_q5_c.isChecked()){
            q5 = "c";

        }else
        if(rb_q5_d.isChecked()){
            q5 = "d";

        }else
        if(rb_q5_e.isChecked()){
            q5 = "e";
        }
        ...
        if(rb_q6_b.isChecked()){
            q6 = "b";

        }else
        if(rb_q6_c.isChecked()){
            q6 = "c";

        }else
        if(rb_q6_d.isChecked()){
            q6 = "d";

        }else
        if(rb_q6_e.isChecked()){
            q6 = "e";

        }else
        if(rb_q6_f.isChecked()){
            q6 = "f";
        }
        if(rb_q7_a.isChecked()){
            q7 = "a";
        }else
        if(rb_q7_b.isChecked()){
            q7 = "b";
        }
        db.addDados(new Dados(sexo, idade, escolaridade, quantidade, q1, q2, q3, q4, q5, q6, q7));
    }
